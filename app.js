...
var state={
  ...
  session:oldSession&&typeof oldSession==='object'?oldSession:null,
  profile:null,
  cart:Array.isArray(oldCart)?oldCart.map(String):[],
  catalog:[],
  filter:'all',
  authMode:'signup',
  authStep:'form',
...
var fallback=[
{id:'f1',title:'Cinematic Road Reveal',category:'cinematic',creator:'Nex Prompt',model:'Kling / Veo',price:2.49,image:'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=900&q=80'},
{id:'f2',title:'Ocean Orbit Motion',category:'nature',creator:'Nex Prompt',model:'Veo',price:2.29,image:'https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?auto=format&fit=crop&w=900&q=80'},
{id:'f3',title:'Neon City Push In',category:'sci-fi',creator:'Nex Prompt',model:'Kling',price:2.99,image:'https://images.unsplash.com/photo-1519608487953-e999c86e7455?auto=format&fit=crop&w=900&q=80'},
{id:'f4',title:'Beach Sunrise Drift',category:'nature',creator:'Nex Prompt',model:'Veo',price:1.99,image:'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=900&q=80'}
];
...
'Verification code':['Verification code','លេខកូដបញ្ជាក់'],
'Verify email':['Verify email','បញ្ជាក់អ៊ីមែល'],
'Resend code':['Resend code','ផ្ញើកូដម្ដងទៀត'],
'Back':['Back','ត្រឡប់ក្រោយ'],
'My account':['My account','គណនីរបស់ខ្ញុំ'],
'Open AI Tools':['Open AI Tools','បើក AI Tools'],
'Buy Credits':['Buy Credits','ទិញ Credits'],
'Sign out':['Sign out','ចាកចេញ'],
